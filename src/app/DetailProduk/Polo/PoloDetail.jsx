...
const productData = {
  black: {
    name: 'Black',
    image: '/assetgambar/Polo/Black.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
  charcoal: {
    name: 'Charcoal',
    image: '/assetgambar/Polo/Charcoal.png',
    sizes: ['L']
  },
  sportgrey: {
    name: 'SportGrey',
    image: '/assetgambar/Polo/SportGray.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
  white: {
    name: 'White',
    image: '/assetgambar/Polo/White.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
  Orange: {
    name: 'Orange',
    image: '/assetgambar/Polo/Orange.png',
    sizes: ['L']
  },
  LightPink: {
    name: 'LightPink',
    image: '/assetgambar/Polo/LightPink.png',
    sizes: ['L']
  },
  RoyalBlue: {
    name: 'Royal Blue',
    image: '/assetgambar/Polo/RoyalBlue.png',
    sizes: ['L']
  },
    CarolinaBlue: {
    name: 'Carolina Blue',
    image: '/assetgambar/Polo/CarolinaBlue.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL']
  },
  Navy: {
    name: 'Navy',
    image: '/assetgambar/Polo/Navy.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
  Red: {
    name: 'Ringer Red',
    image: '/assetgambar/Polo/Red.png',
    sizes: ['L']
  },
  Maroon: {
    name: 'Maroon',
    image: '/assetgambar/Polo/Maroon.png',
    sizes: ['L']
  },
  Daisy: {
    name: 'Daisy',
    image: '/assetgambar/Polo/Daisy.png',
    sizes: ['L']
  },
    IrishGreen: {
    name: 'Irish Green',
    image: '/assetgambar/Polo/IrishGreen.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
    ForestGreen: {
    name: 'Forest Green',
    image: '/assetgambar/Polo/ForestGreen.png',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL']
  },
};
...
export default function ProductDetailPolo() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                src="/assetgambar/Polo/KatalogPolo.jpg"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Polo/SizePolo.jpg"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
