...
const productData = {
  black: {
    name: 'Black',
    image: '/assetgambar/LongHeavyWeight/Black.png',
    sizes: ['L']
  },
  sportgrey: {
    name: 'SportGrey',
    image: '/assetgambar/LongHeavyWeight/SportGrey.png',
    sizes: ['L']
  },
  white: {
    name: 'White',
    image: '/assetgambar/LongHeavyWeight/White.png',
    sizes: ['L']
  },
  RoyalBlue: {
    name: 'Royal Blue',
    image: '/assetgambar/LongHeavyWeight/RoyalBlue.png',
    sizes: ['L']
  },
  Navy: {
    name: 'Navy',
    image: '/assetgambar/LongHeavyWeight/Navy.png',
    sizes: ['L']
  },
  Maroon: {
    name: 'Maroon',
    image: '/assetgambar/LongHeavyWeight/Maroon.png',
    sizes: ['L']
  },
  Red: {
    name: 'Red',
    image: '/assetgambar/LongHeavyWeight/Red.png',
    sizes: ['L']
  },
  Gold: {
    name: 'Gold',
    image: '/assetgambar/LongHeavyWeight/Gold.png',
    sizes: ['L']
  },
};
...
export default function ProductDetailLongHeavyWeight() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                src="/assetgambar/LongHeavyWeight/KatalogLongHeavyWeight.jpg"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/LongHeavyWeight/SizeLongHeavyWeight.jpg"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
