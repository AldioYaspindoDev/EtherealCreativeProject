...
const productData = {
  black: {
    name: 'Black',
    image: '/assetgambar/HeavyWeight/Black.png',
    sizes: ['L']
  },
  sportgrey: {
    name: 'SportGrey',
    image: '/assetgambar/HeavyWeight/SportGrey.png',
    sizes: ['L']
  },
  white: {
    name: 'White',
    image: '/assetgambar/HeavyWeight/White.png',
    sizes: ['L']
  },
  RoyalBlue: {
    name: 'Royal Blue',
    image: '/assetgambar/HeavyWeight/RoyalBlue.png',
    sizes: ['L']
  },
  Navy: {
    name: 'Navy',
    image: '/assetgambar/HeavyWeight/Navy.png',
    sizes: ['L']
  },
  Maroon: {
    name: 'Maroon',
    image: '/assetgambar/HeavyWeight/Maroon.png',
    sizes: ['L']
  },
  Red: {
    name: 'Red',
    image: '/assetgambar/HeavyWeight/Red.png',
    sizes: ['L']
  },
  Gold: {
    name: 'Gold',
    image: '/assetgambar/HeavyWeight/Gold.png',
    sizes: ['L']
  },
};
...
export default function ProductDetailHeavyWeight() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                src="/assetgambar/HeavyWeight/SizeHeavyWeight.png"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/HeavyWeight/HeavyWeightKatalog.png"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
