...
const productData = {
  black: {
    name: "Black Namomi",
    image: "/assetgambar/BlackJeans/Black1.png",
    sizes: ["L"],
  },
  black2: {
    name: "Black Namomi",
    image: "/assetgambar/BlackJeans/Black2.png",
    sizes: ["L"],
  },
};
...
const colors = [
  ...
  { key: "black2", class: "bg-black" },
];

export default function ProductDetailBlackH() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          ...
          <div className="bg-white rounded-2xl border-2 border-blue-900 p-4 lg:p-6 overflow-y-auto max-h-[600px]">
            ...
            <div className="text-black mb-4">
              ...
              Premium Black Namomi adalah definisi dari denim yang bold dan
              modern. Dengan warna hitam pekat yang clean, jeans ini memberikan
              kesan sophisticated sekaligus edgy. Cocok untuk kamu yang ingin
              tampil effortless namun tetap standout di setiap kesempatan.
              Nyaman dipakai seharian, tahan lama, dan mudah dipadukan dengan
              outfit apapun Premium Black Namomi adalah pilihan pasti untuk gaya
              yang simple, sleek, dan selalu on point.
            </div>
