...
const productData = {
  black: {
    name: 'Black',
    image: '/assetgambar/Bomber/Black.png',
    sizes: ['L']
  },
  BlackWhite: {
    name: 'Black White',
    image: '/assetgambar/Bomber/BlackWhite.png',
    sizes: ['L']
  },
  Army: {
    name: 'Army',
    image: '/assetgambar/Bomber/Army.png',
    sizes: ['L']
  }
};
...
const colors = [
  ...
  { key: 'BlackWhite', class: 'bg-gray-500' },
  { key: 'Army', class: 'bg-[#556B2F]' }
];

export default function ProductDetailBomber() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                src="/assetgambar/Bomber/SizeBomber.jpg"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Bomber/KatalogBomber.jpg"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
