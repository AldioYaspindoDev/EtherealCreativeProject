...
const productData = {
  black: {
    name: 'Ringer White Black',
    image: '/assetgambar/Ringer/Black.png',
    sizes: ['L']
  },
  forestgreen: {
    name: 'Ringer Forest Green',
    image: '/assetgambar/Ringer/ForestGreen.png',
    sizes: ['L']
  },
  RoyalBlue: {
    name: 'Ringer Royal Blue',
    image: '/assetgambar/Ringer/RoyalBlue.png',
    sizes: ['L']
  },
  Navy: {
    name: 'Ringer Navy',
    image: '/assetgambar/Ringer/Navy.png',
    sizes: ['L']
  },
  Maroon: {
    name: 'Ringer Maroon',
    image: '/assetgambar/RInger/Maroon.png',
    sizes: ['L']
  },
  Red: {
    name: 'Ringer Red',
    image: '/assetgambar/Ringer/Red.png',
    sizes: ['L']
  },
  gold: {
    name: 'Ringer Gold',
    image: '/assetgambar/Ringer/RingerGold.png',
    sizes: ['L']
  },
  grayblack: {
    name: 'Ringer Grey Black',
    image: '/assetgambar/Ringer/GrayBlack.png',
    sizes: ['L']
  },
  graynavy: {
    name: 'Ringer Grey Navy',
    image: '/assetgambar/Ringer/GrayNavy.png',
    sizes: ['L']
  },
  graymaroon: {
    name: 'Ringer Grey Maroon',
    image: '/assetgambar/Ringer/GrayMaroon.png',
    sizes: ['L']
  },
  grayred: {
    name: 'Ringer Grey Red',
    image: '/assetgambar/Ringer/GrayRed.png',
    sizes: ['L']
  },
};
...
const colors = [
    ...
    { key: 'gold', class: 'bg-yellow-500' },
    { key: 'grayblack', class: 'bg-black' },
    { key: 'graynavy', class: 'bg-[#181E3B]' },
    { key: 'graymaroon', class: 'bg-[#411828]' },
    { key: 'grayred', class: 'bg-[#801A25]' },
];

export default function ProductDetailRinger() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Ringer/SizeRinger.jpg"  
                  alt="Size Guide"
                  fill
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Ringer/KatalogRinger.jpg"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
