...
const productData = {
  black: {
    name: 'Black',
    image: '/assetgambar/Crewneck/Black.png',
    sizes: ['L']
  },
  sportgrey: {
    name: 'SportGrey',
    image: '/assetgambar/Crewneck/SportGray.png',
    sizes: ['L']
  },
  white: {
    name: 'White',
    image: '/assetgambar/Crewneck/White.png',
    sizes: ['L']
  },
  RoyalBlue: {
    name: 'Royal Blue',
    image: '/assetgambar/Crewneck/RoyalBlue.png',
    sizes: ['L']
  },
  Red: {
    name: 'Red',
    image: '/assetgambar/Crewneck/Red.png',
    sizes: ['L']
  },
  Maroon: {
    name: 'Maroon',
    image: '/assetgambar/Crewneck/Maroon.png',
    sizes: ['L']
  },
  ForestGreen: {
    name: 'Forest Green',
    image: '/assetgambar/Crewneck/ForestGreen.png',
    sizes: ['L']
  },
  Navy: {
    name: 'Navy',
    image: '/assetgambar/Crewneck/Navy.png',
    sizes: ['L']
  },
  BlackCamo: {
    name: 'BlackCamo',
    image: '/assetgambar/Crewneck/BlackCamo.png',
    sizes: ['L']
  },
  ForestCamo: {
    name: 'ForestCamo',
    image: '/assetgambar/Crewneck/ForestCamo.png',
    sizes: ['L']
  },
};
...
const colors = [
  ...
  { key: 'BlackCamo', class: 'bg-[#181E3B]' },
];

export default function ProductDetailCrewneck() {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Crewneck/SizeCrewneck.jpg"
                  alt="Size Guide"
                  fill
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              ...
              <div className="relative w-full aspect-[4/3]">
                <Image
                  src="/assetgambar/Crewneck/KatalogCrewneck.jpg"
                  alt="Product Detail"
                  fill
                  className="object-contain rounded-xl"
                />
